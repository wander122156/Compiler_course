...
TODO: Разобраться с read в FakeEnv и в тестах почему по 2 раза все выводит
# Список тестов
...
- [x] Объявление одной переменной без инициализации: `int x` → 0 
- [x] Объявление одной переменной с инициализацией: `int x = 3` → 3
- [x] Объявление нескольких переменных: `int x = 1, y = 2, z = 3` → 3
- [x] Объявление переменных с последующим выражением: `int x = 1, y = 2, z = 3; x + y * z` → 3, 7
- [x] Присваивание объявленным переменным: `int x, y; x = 10; y = 12; x + y` → 0, 10, 12, 22
- [x] Переприсваивание переменных: `int a = 1, b = 2; a = 5; b = a + 1` → 2, 5, 6
...
### Константы
- [x] Объявление константы: `const int c = 3` → 3
- [x] Переменная перекрывает константу: `const int c = 3.14159; int c = 2; 4.0 * c * 4.0` → 3.14159, 2, 50.26548

### Обработка ошибок
- [x] Неопределенная переменная без объявлений: `x + 1` → исключение
- [x] Неопределенная переменная в выражении: `int x, y; x + y + z` → исключение
- [x] Неправильный идентификатор: `int 123` → исключение
